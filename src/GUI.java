...
public class GUI {
    ...
    static void CompararFor1While2(ArrayList<ArrayList<String>> tokensString1fors, ArrayList<ArrayList<String>> tokensString2whiles
        ...
        try{
            ...
            for(ArrayList<Integer> tokens: tokensTypes1fors){
                Collections.sort(tokens);
            }
            for(ArrayList<Integer> tokensWhiles: tokensType2whiles){
                Collections.sort(tokensWhiles);
            }
            int iguales_type = 0;
            ...
            for(int i = 0; i < tokensTypes1fors.size();i++){
                for(int j = 0; j < tokensType2whiles.size(); j++){
                    ...
                    for(Integer twhile: temporal_whiles){
                        if(temporal_fors.contains(twhile)){
                            temporal_fors.remove(twhile);
                            iguales_type++;
                        }
                    }
            ...
            for(Float[] estru : estru_iguales){
                float for_p = estru[2];
                float while_p =  estru[3];
        ...
        realizarAnalisisButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try{
                    ...
                    System.out.println(tokensString1);
                    System.out.println(tokensString2);
                ...
                switch (caso) {
                    case "Jaccard":
                            ...
                            while(tokensType2.size()>0){
                                ...
                                if(tokensType2.get(l).equals(tokensType1.get(l))){
